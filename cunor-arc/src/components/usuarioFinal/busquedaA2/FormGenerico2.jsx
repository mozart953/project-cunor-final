...
function FormGenerico2Component({onSubmit, busqueda, setBusqueda, placeholder}){
                
    return(
        <>
                <div className="mb-3 d-flex justify-content-center align-items-center">
                        <form className="input-group" style={{maxWidth: "100%"}} onSubmit={onSubmit}>
...
export default FormGenerico2Component;