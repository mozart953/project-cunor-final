...
function GraficoBarrasComponent(){
        ...
        useEffect(
            ()=>{
                const datos = async()=>{
                    const respuesta = await fetch(`/api/datos/reDatosGraficos/datosGraficosAdmin`);
                    const datos = await respuesta.json();
                    console.log(datos);

                    if(respuesta.ok){
                        setTotal(datos.totalUsuarios);
        ...
        useEffect(
            ()=>{
                if(total!==null && activos!==null && inactivos!==null){
                    ...
                    setUsuarios([total,activos, inactivos]);
                }
            },[activos, inactivos]);
