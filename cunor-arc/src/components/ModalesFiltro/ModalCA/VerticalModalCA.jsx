...
function MyVerticallyCenteredModalCA({setBusqueda,...props}) {
    ...
    useEffect(()=>{
      //console.log("idUse: " + props.idusuario + "idCarrera " + props.idcarrera);
            ...
            fetch(`/api/datos/reDetallesTrabajoInicial/filtroCarrerasP?&page=${currentpage}&itemsPagina=${itemspagina}&idEstado=${estado}&searchTerm=${busquedaA}&orderDirection=${valorseleccionado}&orderCampo=${valorseleccionado2}`)
    ...
    const onSubmit = async (e)=>{
      ...
      const respuesta = await fetch(`/api/datos/reDetallesTrabajoInicial/filtroCarrerasP?&page=${currentpage}&itemsPagina=${itemspagina}&idEstado=${estado}&searchTerm=${busquedaA}&orderDirection=${valorseleccionado}&orderCampo=${valorseleccionado2}`);
