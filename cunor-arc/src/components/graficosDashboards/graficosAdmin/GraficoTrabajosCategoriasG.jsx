...
function GraficoTrabajosCategoriasGComponent(){
    ...
    const [items2,setItems2] = useState([]);
        ...
        useEffect(
            ()=>{
                const datos = async()=>{
                    const respuesta = await fetch(`/api/datos/reDatosGraficos/datosGraficosAdmin/datosTrabajosCategoriasG`);
...
export default GraficoTrabajosCategoriasGComponent;