...
function GraficoTrabajosTotalesComponent(){
        ...
        useEffect(
            ()=>{
                    ...
                    const datos = async()=>{
                        const respuesta = await fetch(`/api/datos/reDatosGraficos/datosGraficosOperativo/datosTrabajosTotales`);
...
export default GraficoTrabajosTotalesComponent;