...
function MyVerticallyCenteredModalF({setBusqueda,...props}) {
    ...
    useEffect(()=>{
      ...
      const letraS= letraSeleccionada!==''&&letraSeleccionada!==null?`&letra=${letraSeleccionada}`:'';
        if(props.idusuario && props.idcarrera){
            fetch(`/api/datos/reDetalleTrabajoInterno/filtroAutores?idUsuario=${props.idusuario}&idCarrera=${props.idcarrera}&page=${currentpage}&itemsPagina=10&searchTerm=${busquedaA}&orderDirection=${valorseleccionado}&orderCampo=${valorseleccionado2}${letraS}`)
    ...
    const onSubmit = async (e)=>{
      ...
      const respuesta = await fetch(`/api/datos/reDetalleTrabajoInterno/filtroAutores?idUsuario=${props.idusuario}&idCarrera=${props.idcarrera}&page=${currentpage}&itemsPagina=10&searchTerm=${busquedaA}&orderDirection=${valorseleccionado}&orderCampo=${valorseleccionado2}${letraS}`);
...
export default MyVerticallyCenteredModalF;