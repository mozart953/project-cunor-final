...
function GraficoTrabajosCarrerasGComponent(){
    ...
    const [carreras,setCarreras] = useState([]);
        ...
        useEffect(
            ()=>{
                const datos = async()=>{
                    const respuesta = await fetch(`/api/datos/reDatosGraficos/datosGraficosAdmin/datosTrabajosCarreasG`);
...
export default GraficoTrabajosCarrerasGComponent;