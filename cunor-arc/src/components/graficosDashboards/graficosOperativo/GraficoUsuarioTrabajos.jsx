...
function GraficoUsuarioTrabajosComponent({idUsuario, idCarrera}){
        ...
        useEffect(
            ()=>{
                if(idusuario && idcarrera){
                    const datos = async()=>{
                        const respuesta = await fetch(`/api/datos/reDatosGraficos/datosGraficosOperativo/datosTrabajosUsuario?idUsuario=${idusuario}&idCarrera=${idcarrera}`);
...
export default GraficoUsuarioTrabajosComponent;