...
function MyVerticallyCenteredModalC({setBusqueda,...props}) {
    ...
    useEffect(()=>{
      console.log("idUse: " + props.idusuario + "idCarrera " + props.idcarrera);
        if(props.idusuario && props.idcarrera){
            fetch(`/api/datos/reDetalleTrabajoInterno/filtroCategoriasP?idUsuario=${props.idusuario}&idCarrera=${props.idcarrera}&page=${currentpage}&itemsPagina=${itemspagina}&searchTerm=${busquedaA}&orderDirection=${valorseleccionado}&orderCampo=${valorseleccionado2}`)
    ...
    const onSubmit = async (e)=>{
      ...
      const respuesta = await fetch(`/api/datos/reDetalleTrabajoInterno/filtroCategoriasP?idUsuario=${props.idusuario}&idCarrera=${props.idcarrera}&page=${currentpage}&itemsPagina=${itemspagina}&searchTerm=${busquedaA}&orderDirection=${valorseleccionado}&orderCampo=${valorseleccionado2}`);
